...
export const ProModel = () => {
    ...
    const onSubscribe1 = async () => {
        try {
            setLoading(true)
            const respon = axios.get("/api/razorpay");
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center pt-2 space-y-2 text-zinc-900 font-medium">
                        ...
                        <h1 className="text-xl flex justify-center text-center ltt dark:dtt">Upgrade <Zap className="w-4 h-7 ml-2 a fill-white" /> </h1>
